...
public class FallingFence extends FallingBlock {
	...
	public BlockState getStateForPlacement(BlockItemUseContext context) {
		...
		return super.getStateForPlacement(context).with(NORTH, this.canConnect(blockstate, blockstate.isSolidSide(iblockreader, blockpos1, Direction.SOUTH), Direction.SOUTH))
	...
	public void onEndFalling(World worldIn, BlockPos pos, BlockState fallingState, BlockState hitState) {
		...
		BlockState bs = this.getDefaultState()
				.with(NORTH, this.canConnect(blockstate, blockstate.isSolidSide(worldIn, blockpos1, Direction.SOUTH), Direction.SOUTH))
				.with(EAST, this.canConnect(blockstate1, blockstate1.isSolidSide(worldIn, blockpos2, Direction.WEST), Direction.WEST))
				.with(SOUTH, this.canConnect(blockstate2, blockstate2.isSolidSide(worldIn, blockpos3, Direction.NORTH), Direction.NORTH))
				.with(WEST, this.canConnect(blockstate3, blockstate3.isSolidSide(worldIn, blockpos4, Direction.EAST), Direction.EAST))
				.with(WATERLOGGED, ifluidstate.getFluid() == Fluids.WATER);
