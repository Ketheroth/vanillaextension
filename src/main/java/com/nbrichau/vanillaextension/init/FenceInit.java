...
public class FenceInit {
	...
	public static final RegistryObject<Block> oak_leaves_fence = register("oak_leaves_fence", new FenceBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2f).sound(SoundType.GRASS)));
	public static final RegistryObject<Block> spruce_leaves_fence = register("spruce_leaves_fence", new FenceBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2f).sound(SoundType.GRASS)));
	public static final RegistryObject<Block> birch_leaves_fence = register("birch_leaves_fence", new FenceBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2f).sound(SoundType.GRASS)));
	public static final RegistryObject<Block> jungle_leaves_fence = register("jungle_leaves_fence", new FenceBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2f).sound(SoundType.GRASS)));
	public static final RegistryObject<Block> acacia_leaves_fence = register("acacia_leaves_fence", new FenceBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2f).sound(SoundType.GRASS)));
	public static final RegistryObject<Block> dark_oak_leaves_fence = register("dark_oak_leaves_fence", new FenceBlock(BlockBehaviour.Properties.of(Material.LEAVES).strength(0.2f).sound(SoundType.GRASS)));
